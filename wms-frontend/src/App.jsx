...
import MinhaEmpresa from './pages/Configuracao/MinhaEmpresa'; // <--- NOVA
import GestaoEmpresas from './pages/Admin/GestaoEmpresas';   // <--- NOVA
        ...
        <AuthProvider>
          ...
          <Routes>
            ...
            <Route element={<PrivateRoute><MainLayout /></PrivateRoute>}>
              ...
              <Route path="/config/empresa" element={<MinhaEmpresa />} /> {/* <--- Rota Atualizada */}
              <Route path="/admin/empresas" element={<GestaoEmpresas />} /> {/* <--- Rota Master */}
            </Route>
